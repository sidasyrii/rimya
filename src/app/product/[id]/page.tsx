...
import { Heart, Truck, ShieldCheck, Star, Minus, Plus, Share2, MapPin, PlayCircle } from "lucide-react";
  ...
  useEffect(() => {
    async function fetchProduct() {
      ...
      if (data) {
        setProduct({
          ...data,
          // Ensure there's always at least one image to prevent crash
          images: data.images?.length > 0 ? data.images : ["https://images.unsplash.com/photo-1549465220-1a8b9238cd48?q=80&w=800&auto=format&fit=crop"]
        });
