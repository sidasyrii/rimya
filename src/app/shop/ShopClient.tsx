  ...
  useEffect(() => {
    async function fetchProducts() {
      if (isInitialMount) {
        ...
        // Only skip fetching if we have default filters. 
        // If filters were somehow initialized differently, we'd fetch, but here they are defaults.
        return;
      }
    ...
    fetchProducts();
  }, [supabase, selectedCategories, maxPrice, inStockOnly, sortBy, isInitialMount]);
