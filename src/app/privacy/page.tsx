    ...
    <main className="min-h-screen bg-background pt-24">
      ...
      <div className="container mx-auto px-4 py-16 max-w-4xl">
        ...
        <div className="prose prose-stone max-w-none text-foreground/80 space-y-6">
          <p>This Privacy Policy describes how Anubandhan ("we", "us", or "our") collects, uses, and shares your personal information when you visit or make a purchase from our website.</p>
